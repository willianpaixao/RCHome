...
public class Serial implements SerialPortEventListener {
	...
	public Serial() throws SerialException {
		...
		try {
			...
			throw new SerialException("Serial port '" + "/dev/ttyUSB0" + "' already in use.  Try quiting any programs that may be using it.");
		} catch (Exception e) {
			throw new SerialException("Error opening serial port '" + "/dev/ttyUSB0" + "'.", e);
		}

		if (port == null) {
			throw new SerialNotFoundException("Serial port '" + "/dev/ttyUSB0" + "' not found.  Did you select the right one from the Tools > Serial Port menu?");
		}
	}
	public void dispose() {
		try {
